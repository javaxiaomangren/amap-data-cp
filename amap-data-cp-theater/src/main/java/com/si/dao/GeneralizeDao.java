...
public class GeneralizeDao {
	...
	public int getCount(String sql,Map param) {
		return namedJdbcTemplate.queryForInt(sql, param);
	}
	...
	@SuppressWarnings("rawtypes")
	public List queryForList(String sql,Map<String, Object> map) {
		if(map==null) {
			map = new HashMap<String, Object>();
		}
		return namedJdbcTemplate.queryForList(sql, map);
	}
