...
public class QingbaoBaseMain {
	private final static Logger log = LoggerFactory.getLogger(QingbaoBaseMain.class);
	...
	public void run() throws Exception {
		...
		if (error_status.equals("run")) {
			...
			try {
				new QingbaoAddSave().dealSave("qingbao_base", false);
			} catch (Exception e) {
				log.info(e.toString());
			}
