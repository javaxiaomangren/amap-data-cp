...
public class MiningShapeMain {
	private final static Logger log = LoggerFactory.getLogger(MiningShapeMain.class);
	...
	public void run() throws Exception {
		...
		if (error_status.equals("run")) {
			...
			try {
				new MiningShapeSave().dealSave("mining_shape", false);
			} catch (Exception e) {
				log.info(e.toString());
			}
