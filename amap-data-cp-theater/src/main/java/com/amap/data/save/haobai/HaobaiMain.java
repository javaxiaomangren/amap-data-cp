 ...
 */
package com.amap.data.save.haobai;
...
public class HaobaiMain {
	private final static Logger log = LoggerFactory.getLogger(HaobaiMain.class);
	...
	public void run() throws Exception {
		...
		if (error_status.equals("run")) {
			...
			try {
				new HaobaiSave().dealSave("dianxin_haobai", false);
			} catch (Exception e) {
				log.info(e.toString());
			}
