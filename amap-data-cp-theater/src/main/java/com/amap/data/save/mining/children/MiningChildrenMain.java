...
public class MiningChildrenMain {
	private final static Logger log = LoggerFactory.getLogger(MiningChildrenMain.class);
	...
	public void run() throws Exception {
		...
		if (error_status.equals("run")) {
			...
			try {
				new MiningChildrenSave().dealSave("mining_children", false);
			} catch (Exception e) {
				log.info(e.toString());
			}
