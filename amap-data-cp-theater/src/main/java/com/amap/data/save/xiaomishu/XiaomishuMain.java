...
public class XiaomishuMain {
	private final static Logger log = LoggerFactory.getLogger(XiaomishuMain.class);
	...
	public void run() throws Exception {
		...
		if (error_status.equals("run")) {
			...
			try {
				new XiaomishuSave().dealSave("dining_xiaomishu_api", false);
			} catch (Exception e) {
				log.info(e.toString());
			}
