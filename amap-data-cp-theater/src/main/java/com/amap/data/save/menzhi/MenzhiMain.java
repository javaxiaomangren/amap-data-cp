 ...
 * 2013-5-23
 */
package com.amap.data.save.menzhi;
...
public class MenzhiMain {
	private final static Logger log = LoggerFactory.getLogger(MenzhiMain.class);
	...
	public void run() throws Exception {
		...
		if (error_status.equals("run")) {
			...
			try {
				new MenzhiSave().dealSave("site_collect", false);
			} catch (Exception e) {
				log.info(e.toString());
			}
