 ...
 * 2013-5-23
 */
package com.amap.data.save.ali.add.kaifanla;
...
public class AliKaifanlaMain {
	private final static Logger log = LoggerFactory.getLogger(AliKaifanlaMain.class);
	...
	public void run() throws Exception {
		...
		if (error_status.equals("run")) {
			...
			try {
				new AddSave().dealSave("ali_kaifanla", false);
			} catch (Exception e) {
				log.info(e.toString());
			}
