 ...
 * 2013-5-23
 */
package com.amap.data.save.ali.add.qqfood;
...
public class AliQQFoodMain {
	private final static Logger log = LoggerFactory.getLogger(AliQQFoodMain.class);
	...
	public void run() throws Exception {
		...
		if (error_status.equals("run")) {
			...
			try {
				new AddSave().dealSave("ali_qqfood", false);
			} catch (Exception e) {
				log.info(e.toString());
			}
