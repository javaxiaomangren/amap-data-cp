 ...
 * 2013-5-23
 */
package com.amap.data.save.ali.add.fantong;
...
public class AliFantongMain {
	private final static Logger log = LoggerFactory.getLogger(AliFantongMain.class);
	...
	public void run() throws Exception {
		...
		if (error_status.equals("run")) {
			...
			try {
				new AddSave().dealSave("ali_fantong", false);
			} catch (Exception e) {
				log.info(e.toString());
			}
