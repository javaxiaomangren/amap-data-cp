 ...
 * 2013-5-23
 */
package com.amap.data.save.ali.add.qunar;
...
public class AliQunarMain {
	private final static Logger log = LoggerFactory.getLogger(AliQunarMain.class);
	...
	public void run() throws Exception {
		...
		if (error_status.equals("run")) {
			...
			try {
				new AddSave().dealSave("ali_qunar", false);
			} catch (Exception e) {
				log.info(e.toString());
			}
