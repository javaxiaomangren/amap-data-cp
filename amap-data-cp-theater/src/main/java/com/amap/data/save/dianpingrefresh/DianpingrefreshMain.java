 ...
 * 2013-5-23
 */
package com.amap.data.save.dianpingrefresh;
...
public class DianpingrefreshMain {
	private final static Logger log = LoggerFactory.getLogger(DianpingrefreshMain.class);
	...
	public void run() throws Exception {
		...
		if (error_status.equals("run")) {
			...
			try {
				new DianpingrefreshSave().dealSave("dianping_refresh", false);
			} catch (Exception e) {
				log.info(e.toString());
			}
