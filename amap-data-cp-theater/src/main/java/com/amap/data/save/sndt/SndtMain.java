 ...
 * 2013-5-23
 */
package com.amap.data.save.sndt;
...
public class SndtMain {
	private final static Logger log = LoggerFactory.getLogger(SndtMain.class);
	...
	public void run() throws Exception {
		...
		if (error_status.equals("run")) {
			...
			try {
				new SndtSave().dealSave("sndt", false);
			} catch (Exception e) {
				log.info(e.toString());
			}
