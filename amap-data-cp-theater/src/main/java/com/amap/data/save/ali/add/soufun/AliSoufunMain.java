 ...
 * 2013-5-23
 */
package com.amap.data.save.ali.add.soufun;
...
public class AliSoufunMain {
	private final static Logger log = LoggerFactory.getLogger(AliSoufunMain.class);
	...
	public void run() throws Exception {
		...
		if (error_status.equals("run")) {
			...
			try {
				new AddSave().dealSave("ali_soufun", false);
			} catch (Exception e) {
				log.info(e.toString());
			}
